...
if(mysqli_num_rows($result)>0){
    ...
    echo "<h1>SHOW LIST PRODUCT</h1>";
    echo "<table border=1><tr><th>order_id</th><th>name</th><th>price</th><th>fname</th><th>lname</th><th>address</th><th>mobile</th></tr>";
    while($row=mysqli_fetch_assoc($result)){
        ...
        echo "<tr><td style='text-align: center;'>".$row["order_id"]."</td><td style='text-align: center;'>".$row["name"]."<td style='text-align: center;'>".$row["price"]."</td><br><td>" ; 
